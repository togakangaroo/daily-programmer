...
***  Calculate point of intersection
    ...
    Let's do a sanity check here. if
    

    | *Square Width*                 | 10                                                |
    | *F(rom)*                       | (2,7)                                             |
    | *T(o)*                         | (15, 11)                                          |
    | *(i)ntersection approximation* | ~(10, 9)                                          |
    | *intersection calculated*      | \((10, 7 + (10-2) \frac {11-7} {15-2}) = 9.4615\) |


    ok yeah, that's not right. Where did this go wrong?
