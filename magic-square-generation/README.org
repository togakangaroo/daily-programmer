...
Damn, that one still timed out. It's such a huge ramp up in execution time that I feel no amount of optimization will help, but lets just try a few more optimizations to see if we can get past the hump
